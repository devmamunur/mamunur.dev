  ...
  return (
    <>
      <Link
        ...
        className="col-span-2 mt-6 section-card-wrapper"
      >
        <div className="group section-card">
          <div className="flex justify-between">
            ...
            <Link
              href="src/components/Web/Opensource#"
          ...
          <h6 className="text-1xl font-bold text-sky-500">
            PMSGO, Advanced-JavaScript-Guide, mamunur.dev, ...
          </h6>
        </div>
      </Link>
    </>
