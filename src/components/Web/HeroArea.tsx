        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex items-center w-full py-6 px-6 rounded-2xl mt-6 dark:bg-slate-800 relative">
            ...
            <div className=" text-center md:text-left">
              <h1 className="mb-1 text-5xl font-bold text-gray-900 mb-3 uppercase dark:text-white">
                Mamunur Rashid
              </h1>
              <h6 className="text-2xl mb-3 text-gray-100 dark:text-gray-200">
                Software Developer
              </h6>
              <p className="text-1xl text-gray-100 dark:text-gray-200">
                Full Stack Web Developer | Open Source Enthusiast | JavaScript,
                TypeScript, Node.js, React.js, Vue.js | 4 years of industry
                experience.
              </p>
