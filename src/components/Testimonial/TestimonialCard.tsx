...
const TestimonialCard : React.FC = () => {
    return (
        <>
            <div className="col-span-1 bg-white py-6 px-6 rounded-2xl dark:bg-gray-800">
                <div className="text-center md:text-left">
                    ...
                    <h6 className="text-2xl text-gray-100 font-bold uppercase dark:text-gray-200">Testimonial</h6>
                </div>
            </div>
        </>
    );
